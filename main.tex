...
Depois de fazer o produto interno, será calculada a diferença (erro) do resultado de cada produto interno com o valor da PetalWidthCm de cada amostra e colocada numa lista que posteriormente será percorrida para cada erro ser transformado em seu módulo. 
